...
class DropdownButtonUpdate<T> extends StatefulWidget {
  ...
  DropdownButtonUpdate._formField({
    super.key,
    required this.items,
    this.selectedItemBuilder,
    this.value,
  ...
  @override
  State<DropdownButtonUpdate<T>> createState() =>
      _DropdownButtonUpdateState<T>();
}

class _DropdownButtonUpdateState<T> extends State<DropdownButtonUpdate<T>>
  ...
  @override
  void didUpdateWidget(DropdownButtonUpdate<T> oldWidget) {
